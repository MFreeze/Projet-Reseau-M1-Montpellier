...
\item -P numero de port qu'utilise le serveur de réception (par default '13322')
\end{itemize}

La demande de contrôle de la caméra s'effectue en pressant la touche 'c'. La direction est donnée grâce aux touches directionnelles.
